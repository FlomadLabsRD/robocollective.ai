...
export const catalogData: Record<string, { id: string, title: string, products: any[] }[]> = {
    drones: [
        ...
        {
            id: "spares", title: "Accessories & Spares", products: [
    ...
    educational: [
        {
            id: "robots", title: "Educational & Bipedal Robots", products: [
                ...
                { id: "g1", name: "Humanoid G1 (Base/EDU)", description: "The Unitree G1 humanoid robot — next-generation bipedal platform with up to 43 DOF.", price: "Quote" },
            ]
        },
    ],
    ...
    industrial: [
        ...
        {
            id: "compound", title: "Compound & Mobile Arms", products: [
        ...
        {
            id: "amr", title: "AMRs & Chassis", products: [
        ...
        {
            id: "grippers", title: "Grippers & End Effectors", products: [
        ...
        {
            id: "cameras", title: "Cameras & Sensors", products: [
    ...
    service: [
        {
            id: "hospitality", title: "Hospitality & Delivery", products: [
                ...
                { id: "s4", name: "Mars Smartbot", description: "All-terrain autonomous smartbot designed for outdoor navigation, logistics, and last-mile delivery.", price: "Quote" },
            ]
        },
        {
    ...
    specialty: [
        {
            id: "bipedal", title: "Multi-Modal & Specialty", products: [
                { id: "sp1", name: "Tron 1", description: "World's first multi-modal biped platform — point-foot, sole, and wheeled modes in one robot.", price: "Quote" },
            ]
        },
    ],
};

// Flat lookup: id → product
